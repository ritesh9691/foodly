                    ...
                    child: BottomNavigationBar(
                      ...
                      items: [
                        ...
                        const BottomNavigationBarItem(
                            icon:  Badge(
                              label: Text("1"),
                              child: Icon(FontAwesome.opencart)), label: "category"),
                        BottomNavigationBarItem(
                            icon:controller.tabIndex.value == 3?const  Icon(FontAwesome.user_circle):const Icon(FontAwesome.user_circle_o),
                            label: "profile"),
                      ],
                    ),
                  ),),
